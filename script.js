...
class Products {
    async getProducts() { // get products to api
        try {
            let result = await fetch("https://6466986d2ea3cae8dc1ab189.mockapi.io/products");
...
class UI {
    ...
    getBagButtons() {
        const buttons = [...document.querySelectorAll(".btn-add-to-cart")]; //buton olarak array
        buttonsDOM = buttons;
